...
import { Position } from '../app/models/position.enum';
import { environment as environmentProd } from './environment.prod';

const candidats: Candidat[] = environmentProd.candidats.concat([
  {
    firstName: 'John',
    lastName: 'Doe',
    pictureUrl: 'https://fakeimg.pl/375x200/ff0000,128/000,255',
    age: 42,
